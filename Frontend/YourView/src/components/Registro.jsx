  ...
  return (
    <div className="min-h-screen flex flex-col gap-10 dark:text-gray-500 dark:bg-black dark:bg-opacity-80 items-center justify-center bg-salmon p-5 font-Source text-black">
      ...
      >
        ...
        <input
          value={user == "Cliente" ? nombreU : nombreA}
          onChange={(e) => {
            user == "Cliente"
        ...
        />
        <input
          value={user == "Cliente" ? claveU : claveA}
          onChange={(e) => {
            user == "Cliente"
        ...
        <input
          className="p-3 bg-white rounded-lg border-azul border-4 w-full"
          value={user == "Cliente" ? iconU : iconA}
          onChange={(e)=>{user=='Cliente'?setIconU(e.target.value):setIconA(e.target.value)}}
          type="text"
          name=""
          id=""
          placeholder="Icon"
